...
<div class="btn-group dropup btn-group-new-section">
    ...
    <ul class="dropdown-menu">
        <li>
            <button class="btn btn-section-create" style="background: none; width: 100%; text-align: left; " name="text">
                <span class="glyphicon glyphicon-align-justify" title="Text"></span> Text
            </button>
        </li>
        <li>
            <button class="btn btn-section-create" style="background: none; width: 100%; text-align: left; " name="gallery" title="Gallery">
